...
<div class="container custom-container shadow">
    ...
    <div class="table-responsive table-div">
        <div class="d-flex justify-content-end">
            <div>
                <span class="">Worked today </span><div id="time_worked">{{$time_worked}}</div>
            </div>
                ...
                @else
                    @foreach($tasks as $key => $task)
                        <tr id="task_{{$task->id}}">
                            ...
                            <td>
                                <span onclick="showHistory({{$task->id}}, 'show')" id="show_history_{{$task->id}}" class="history-icon">
                                    <i class="fa fa-plus-square "  data-toggle="tooltip" data-placement="top" title="Show task history"></i>
                                </span>
                                <span onclick="showHistory({{$task->id}}, 'hide')" id="hide_history_{{$task->id}}" class="history-icon d-none">
